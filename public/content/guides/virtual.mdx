...
1. Select 'New'.
2. Name the virtual machine. If you're installing https://www.ulosino.com/browse/ubuntu>Ubuntu</Link>, you might call it 'Ubuntu VM'. This helps when you scale up with more VMs.
